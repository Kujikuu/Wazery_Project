               ...
               using (System.IO.StreamReader read = System.IO.File.OpenText(Program.ServerConfig.DbLocation + "npcs.ini"))
               {
                   while (true)
                   {
                       ...
                       if (aline != null && aline != "")
                       {
                         ...
                         if (np.UID == 16851 /*ClassPkWarReward*/|| np.UID == 168052 /*ExitElitePk*/|| np.UID == 20014 /*MsConquerRewardNPC*/|| np.UID == 20013 /*MrConquerRewardNPC*/|| np.UID == 16852/*PkWarQuit*/|| np.UID == 16853/*PkWarQuit*/)
                            {
                   ...
                   Console.WriteLine(" # Load [" + Count + "] Npcs !");
               }
           }
