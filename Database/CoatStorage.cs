   ...
   public class CoatStorage
    {
       ...
       public static void Load()
       {
           ...
           foreach (var bas_line in baseText)
           {
                ...
                //int count = 1;
                //var result = line.ToLookup(v => v).Select(x => new { Value = x.Key, Count = x.Count() });
               ...
               else
               {
                ...
                //if (line[0] == line[0])
                //    count = count + 1;
                //Console.WriteLine(" # Load [" + line[0] + "] duplicate !" + count);
                //Console.WriteLine("\t\n " + result + " out of " + count);

                //Console.WriteLine(" # Load [" + bas_line + "] bas_line !");
            }
        }
