                ...
                case SlotMachineSubType.StartSpin:
                    {
                        ...
                        {
#if TEST
                                Console.WriteLine("NpcID = "+npc.UID+" Mesh = "+npc.Mesh+"");
#endif
                                ...
                                if (npc.Mesh / 10 >= 1977 && npc.Mesh / 10 <= 1980)
                                {
                                    ...
                                    cost *= BetMultiplier;
#if TEST
                                    Console.WriteLine("You bet is " + cost + " the type is : " + (string)(cps ? "ConquerPoints" : "Money") + "");
#endif
...
#if TEST
                            Console.WriteLine("You won is " + reward.ToString() + " the type is : " + (string)(user.SlotMachine.Cps ? "ConquerPoints" : "Money") + "");
#endif
