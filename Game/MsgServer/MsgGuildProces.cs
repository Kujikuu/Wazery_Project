                ...
                case GuildAction.Resign:
                    {
                        ...
                        if (user.Player.MyGuild.Members.Count >= 20)
                        {
                            user.Player.Owner.SendSysMesage("I'm sorry , but your Guild already is at the max number of members of " + 20 + ".");
                            break;
                        }
                ...
                case GuildAction.AcceptRequest:
                    {
                        ...
                        if (user.Player.View.TryGetValue(UID, out obj, Role.MapObjectType.Player))
                        {
                            ...
                            if (user.Player.MyGuild.Members.Count >= 20)
                            {
                                Target.Player.Owner.SendSysMesage("I'm sorry , but your Guild already is at the max number of members of " + 20 + ".");
                                break;
                            }
                ...
                case GuildAction.JoinRequest:
                    {
                        ...
                        if (user.Player.View.TryGetValue(UID, out obj, Role.MapObjectType.Player))
                        {
                            ...
                            if (Target.Player.MyGuild == null || Target.Player.MyGuildMember == null)
                                break;
                            if (Target.Player.MyGuild.Members.Count >= 20)
                            {
                                Target.Player.Owner.SendSysMesage("I'm sorry , but the Guild already is at the max number of members of " + 20 + ".");
                                break;
                            }
