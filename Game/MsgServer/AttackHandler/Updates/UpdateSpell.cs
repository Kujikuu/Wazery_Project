...
namespace LightConquer_Project.Game.MsgServer.AttackHandler.Updates
{
            ...
            if (DBSpells != null)
            {
                ...
                if (client.MySpells.ClientSpells.TryGetValue(Attack.SpellID, out ClientSpell))
                {
                    ...
                    if (ClientSpell.Level < DBSpells.Count - 1)
                    {
                        ...
                        {
                            ClientSpell.Experience += (int)(Damage * Program.ServerConfig.ExpRateSpell);//bahaa
                            ClientSpell.Experience += (int)(Damage * Program.ServerConfig.ExpRateSpell * client.GemValues(Role.Flags.Gem.NormalMoonGem)) / 100;
