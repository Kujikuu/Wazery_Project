...
namespace LightConquer_Project.Game.MsgServer.AttackHandler.Calculate
{
    public static class Base
    {
        ...
        public static bool Dodged(Client.GameClient attacker, Client.GameClient target)//bahaa
        {
            //return false;
        ...
        public static bool Dodged(Client.GameClient attacker,Game.MsgMonster.MonsterRole target)//bahaa
        {
            //return false;
