...
{
    public class MsgWeeklyPKChampion
    {
        public const ushort MapID = 9998;
        public const uint RewardConquerPoints = 50000000;
        public const string FilleName = "\\WeeklyPKChampion.ini";
        ...
        public MsgWeeklyPKChampion(ProcesType _Proces)
        {
            Proces = _Proces;

            PkWars = new War[(byte)TournamentType.Count][];

            for (TournamentType i = TournamentType.WeeklyPKChampion; i < TournamentType.Count; i++)
            {
        ...
        internal MsgServer.MsgUpdate.Flags ObtainAura(TournamentType typ)
        {
            switch (typ)
            {
                case TournamentType.WeeklyPKChampion: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Warrior: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Archer: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Ninja: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Monk: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Fire: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
                //case TournamentType.Water: return MsgServer.MsgUpdate.Flags.WeeklyPKChampion;
            }
        ...
        internal static TournamentType GetMyTournamentType(Client.GameClient client)
        {
            if (Database.AtributesStatus.IsTrojan(client.Player.Class))
                return TournamentType.WeeklyPKChampion;
        ...
        public class War
        {
            ...
            public void GetMyReward(Client.GameClient client, ServerSockets.Packet stream)
            {
                if (IsFinish(client))
                {
                    ...
                    var aura = MsgSchedules.WeeklyPKChampion.ObtainAura(Typ);
                    ...
                    string reward = "[WeeklyPKChampion]" + client.Player.Name + " has received " + RewardConquerPoints + " from WeeklyPKChampion.";
