            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                {                    
                    ...
                    if (Rank == 1)
                    {
                        ...
                        client.Player.ConquerPoints += 35000;
                        client.Player.Money += 10000000;
                        client.Player.SendUpdate(stream, client.Player.Money, MsgUpdate.DataType.Money);

#if Arabic
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " , 100,000 Money and a wing (WingsofInfernal).");
...
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " , 35,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 35,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
                    ...
                    else if (Rank == 2)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 8,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 25,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 25,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
                    ...
                    else if (Rank == 3)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 30,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 15,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 15,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
                    ...
                    else
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 10,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
