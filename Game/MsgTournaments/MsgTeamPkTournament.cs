            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
...
#if Arabic
                          client.CreateBoxDialog("You've received a " + DBItem.Name + " and 20,000,000 Silvers.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 7,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 50,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 50,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
                    ...
                    else if (Rank == 2)
                    {
                        ...
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 30,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 30,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
...
#if Arabic
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 3000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 3,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 20,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 20,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
...
#if Arabic
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 1000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 1,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 10,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    if (Rank == 1)
                    {
                        ...
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " , 50,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 50,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
...
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 30,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 30,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
...
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 20,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 20,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
...
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 10,000 ConquerPoints & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#endif
