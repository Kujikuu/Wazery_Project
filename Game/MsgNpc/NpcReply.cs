...
namespace LightConquer_Project.Game.MsgNpc
{
    public unsafe static class NpcReply
    {
        ...
        public static unsafe ServerSockets.Packet NpcReplyCreate(this ServerSockets.Packet stream, InteractTypes interactType, string text, ushort InputMaxLength, byte OptionID, bool display = true)
        {
            stream.InitWriter();
