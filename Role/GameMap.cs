...
namespace LightConquer_Project.Role
{
    ...
    public class GameMap
    {
        ...
        {
            return UID == 516076 || UID == 516077 || UID == 516074 || UID == 516075 || UID == 516078 || UID == 516079 || UID == 516080 || UID == 17014 || UID == 17013 || UID == 17012 || UID == 17011 || UID == 17010 || UID == 17009 || UID == 17008 || UID == 17007 || UID == 17006 || UID == 17005 || UID == 17004 || UID == 17003 || UID == 17002 || UID == 17001 || UID == 17000;
        }
        ...
        private static List<ushort> UsingMaps = new List<ushort>()
        {
            ...
            Game.MsgTournaments.MsgMonthlyPKChampion.MapID,
...
/*#if TEST
        ...
        public static void LoadMaps()
        {
            ...
            foreach (var folded in MapContents)
            {
                ...
                if (folded.Key == 1508)// event maps
                {
                    LoadMap(9998, mapFile, 1508);
                }
                if (folded.Key == 2071)
                {
                    LoadMap(6521, mapFile, 2071);
                    LoadMap(10550, mapFile, 2071);
                }
                if (folded.Key == 1766)
                {
            ...
            Console.WriteLine(" # Load [" + Database.Server.ServerMaps.Count + "] maps !");
            GC.Collect();
        ...
        public static void LoadMap(int id, string mapFile, uint baseid = 0)
        {
            ...
            {
                MyConsole.WriteException(e);
                Console.WriteLine("\tMap error: " + id + " - " + mapFile + "");
