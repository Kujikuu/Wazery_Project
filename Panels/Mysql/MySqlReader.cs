...
namespace LightConquer_Project.Database
{
    public unsafe class MySqlReader : IDisposable
    {
        ...
        public const string connectionString = "Server=localhost;Port=3306;Database=enzf_850;Uid=root;Password=;Persist Security Info=True;Pooling=true; Min Pool Size = 32;  Max Pool Size = 300;";
